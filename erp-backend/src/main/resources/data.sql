...
INSERT INTO conveyor (name, status) VALUES ('Conveyor C', 'FAULT');
...
INSERT INTO orders (name, status, product, quantity, created_at, conveyor_id) VALUES ('Order 5', 'CANCELLED', 'Product E', 8, CURRENT_TIMESTAMP, 3);
INSERT INTO orders (name, status, product, quantity, created_at, conveyor_id) VALUES ('Order 6', 'PROCESSING', 'Product F', 30, CURRENT_TIMESTAMP, 3);